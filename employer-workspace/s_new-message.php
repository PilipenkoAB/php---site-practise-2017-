...
if (isset($_POST["contract"])){
  $ContractId=htmlspecialchars($_POST["contract"]);	
...
$Contract_Information_Data = $Contract_Information->fetch_assoc();
	...
	$FreelancerId=$Contract_Information_Data['FreelancerId'];
...
if(!$BD->query("INSERT INTO `Messages` (`IdFrom`,`IdTo`,`Type`,`Message`,`Time`) VALUES ('$User_Id', '$FreelancerId','$ContractId','$NewMessage','$Time')")){
