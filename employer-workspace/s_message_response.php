...
if($Message_Information = $BD->query("SELECT * FROM `Messages` WHERE (`Type`='0' AND `IdFrom`='$User_Id' AND `IdTo`='$ContractId') OR (`IdFrom`='$ContractId' AND `IdTo`='$User_Id' AND `Type`='0') ORDER BY `Time`  ")) { 
