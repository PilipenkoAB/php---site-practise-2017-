...
<li class="FW_top_nav_ul_last">
<a href="accept-contracts.php" class="FW_top_nav_href">Мои контракты</a>
</li>
<li class="FW_top_nav_ul_last">
...
<div class="">
В этом разделе просто входная страница. ВОзможно сбоку панель репутации, быстрые переходы к работам, новости проекта и тд
</div>
