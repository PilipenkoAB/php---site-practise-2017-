...
<section class="FW_middle_tests">
 ...
 <header>
 <h2>Задания, ожидающие ответа</h2>
 </header>
 
<div class="">
<?php
if ($Response_Information = $BD->query("SELECT * FROM `ResponseNewJob` WHERE `FreelancerId`='$id_user' AND `Result`='0'  AND `Deleted`='0' AND `Archive`='0'")) { 
