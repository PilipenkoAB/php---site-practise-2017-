...
<a href="find-work.php" class="FW_top_nav_href">Поиск работы</a>
</li>
<li class="FW_top_nav_ul_last">
...
<br>смена пароля
<form method="post" name="ChangePass" id="ChangePassForm">
<br>Введите старый пароль:
<input type="text" name="PasswordOld" id="PasswordOld"   class="">
<br>Введите новый пароль:
<input type="text" name="PasswordNew" id="PasswordNew"   class="">
<br>Подтвердите новый пароль:
<input type="text" name="PasswordNewCheck" id="PasswordNewCheck"   class="">
<br>
<input type="submit"  id="ChangePass" class="">Сменить пароль</button>
</form>
</div>
